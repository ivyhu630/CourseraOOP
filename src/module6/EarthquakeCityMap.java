...
//        PImage img = loadImage("cityminion.jpeg");
    ...
    private void sortAndPrint(int numToPrint) {
        ...
        System.out.println("total printed # " + numToPrint);
    ...
    /**
     * The event handler for mouse clicks It will display an earthquake and its threat circle of cities Or if a city is
     * clicked, it will display all the earthquakes where the city is in the threat circle
     */
    @Override
