...
//        earthquakesURL = "test2.atom";
    ...
    private void addKey() {
        ...
        triangle(50, 125, 50 + 7, 125 - 7, 50 + 14, 125);
        fill(color(255, 255, 255));
        ellipse(50, 175, 15, 15);
        fill(color(255, 255, 255));
        rect(45, 220, 15, 15);
        fill(color(255, 255, 0));
        ellipse(50, 225 + 100, 15, 15);
        fill(color(0, 255, 0));
        ellipse(50, 225 + 150, 15, 15);
        fill(color(255, 182, 193));
        ellipse(50, 225 + 200, 15, 15);

        fill(0, 0, 0);
        text("City Marker", 75, 125);
        text("Land Quake", 75, 175);
        text("Oncean Quake", 75, 225);
        text("Size ~ Magnitude", 50, 225 + 50);
        text("Shallow", 75, 225 + 100);
        text("intermediate", 75, 225 + 150);
        text("deep", 75, 225 + 200);
    ...
    private void printQuakes() {
        HashMap<String, Integer> countryQuakes = new HashMap<>();
        ...
        System.out.println(countryQuakes);
